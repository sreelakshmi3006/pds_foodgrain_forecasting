# PDS Rice & Wheat Allocation Forecasting

This project builds a **leakage-safe, ML-based forecasting system** for rice and wheat allocations under India’s **Public Distribution System (PDS)**, using large-scale administrative data.

The project combines:
- rigorous time-series feature engineering
- anomaly-aware data validation
...
PDS allocation data exhibits:
- reporting shocks (e.g. COVID-era under-reporting),
- incomplete panels across states,
- strong commodity-specific regional patterns.

Naïve forecasting approaches fail under these conditions.

This project addresses these challenges by:
- explicitly flagging anomalous and incomplete periods,
- preventing temporal leakage in model training,
- forecasting **changes (deltas)** instead of raw levels,
- separating rice and wheat into independent models.
...
### Data
- Monthly, state-level PDS allocation data (Rice & Wheat)
- Period: 2018–2021
- Source: Government of India administrative datasets

### Key Modeling Choices
- **Forecast horizon**: 3 months ahead
- **Target**: Change in allocation (`delta_target`)
- **Models**: Random Forest Regressor
- **Validation**: Time-based, leakage-safe splits
- **Anomaly handling**: Explicit exclusion from training
- **Panel completeness checks**: Commodity-specific thresholds

---

## 📊 Streamlit Dashboard

The project includes an interactive Streamlit app with two sections:

### 1. Diagnostics
- National allocation trends
- Anomaly detection and visualization
- Reporting shock analysis

### 2. Forecasting
- User-selected forecast cutoff (month/year)
- Automated train–validation split
- Separate rice and wheat forecasts
- Normalized performance metrics (R², nMAE, nRMSE)
